                     ...
                     <li>
                        <a href="#"><i class="fa fa-yelp "></i>Sales <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="report.php"><i class="fa fa-coffee"></i>Order Invoice</a>
                            </li>
                            <li>
                                <a href="orderTot.php"><i class="fa fa-coffee"></i>Order Analyze</a>
                            </li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-circle-o"></i> View Details <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                             ...
                             <li>
                                <a href="viewOrder.php"><i class="fa fa-circle-o "></i>View Product </a>
                            </li>
                             <li>
